...
namespace VirtualRealty
{
    ...
    public class Listing
    {
        ...
        public static List<Listing> FilterListings(List<Listing> Listings, int PriceMin = -1, int PriceMax = -1, List<HomeType> Types = null,
            ...
            int MinYear = -1, int MaxYear = -1, bool Washer = false, bool Parking = false, bool Purchase = true, bool Favourite = false, string locationSearchString = "")
        {
            ...
            foreach (Listing L in Listings){
                ...
                if (locationSearchString != null && locationSearchString.Length > 0 && locationSearchString != "Enter your city or neighborhood" && !L.Address.ToUpper().Contains(locationSearchString.ToUpper())) {
                    continue;
                }
